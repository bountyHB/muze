...
-- 프로덕트 넣기 
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사','45.5 x 45 cm', 1200, 5, 'Image/01.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사2','45.5 x 45 cm', 1200, 5, 'Image/02.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사3','45.5 x 45 cm', 1200, 5, 'Image/03.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사4','45.5 x 45 cm', 1200, 5, 'Image/04.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사5','45.5 x 45 cm', 1200, 5, 'Image/05.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사6','45.5 x 45 cm', 1200, 5, 'Image/06.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사7','45.5 x 45 cm', 1200, 5, 'Image/07.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT.NEXTVAL,'와인과 고추장이 있는 식사8','45.5 x 45 cm', 1200, 5, 'Image/08.jpg', 2, SYSDATE, 'dd','STILL-LIFE', 'Y');

-- 마일리지 넣기
-- 회원가입
INSERT INTO MILEAGE VALUES(SEQ_POINT.NEXTVAL, 8, 100000, 'JOIN', SYSDATE-1, 'IN', 100000);
-- 출석이벤트
INSERT INTO MILEAGE VALUES(SEQ_POINT.NEXTVAL, 12, 100, 'ATT', SYSDATE-1, 'IN', );
INSERT INTO MILEAGE VALUES(3, 12, 100, 'ATT', SYSDATE, 'IN', 100200);

-- 주문 넣기
INSERT INTO ORDERS VALUES(SEQ_ORDER_NO.NEXTVAL, 12, 100000, 'JOIN', SYSDATE-1, 'IN', 100000);
